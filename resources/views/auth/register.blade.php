            ...
            <div class="max-w-md mx-auto py-3 px-6 w-full">
              ...
              <div class="flex flex-col-reverse lg:flex-row justify-end mt-4">
                  ...
                  <a class="" href="{{ route('welcome') }}">
                      <button class="w-full lg:w-auto rounded bg-gray-500  text-center text-green-800 font-semibold lg:w-auto py-2 px-6">                    
                        {{ __('Go Back') }}
                      </button>
                  </a>

                  <button class="w-full  lg:ml-2 lg:w-auto bg-green-600 hover:bg-green-500 text-white font-bold py-2 px-6 mr-2 rounded">
                        {{ __('Register') }}
